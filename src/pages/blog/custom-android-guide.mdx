...
pubDate: 11-2-2021
slug: "android-guide"
featuredImage: android-root-gradient.png
description: Root your Android 12 Pixel Phone or Install a custom operating system on it. Full Guide + terminology.
type: "post"
...
<BlogPost title={frontmatter.title} description={frontmatter.description} image={frontmatter.featuredImage} >
