...
import { Minestat } from '../../components/Minestat'
...
<iframe src="http://craft.divnectar.com:8123/" class="border-solid border-2 border-purple rounded" style="margin: auto;" width="70%" height="800">
  <p>Your browser does not support iframes.</p>
</iframe>

## Server Stats
<Minestat client:load />
