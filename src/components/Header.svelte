...
<nav class="bg-surface">
	<div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
		<div class="relative flex h-16 items-center justify-between">
          ...
          on:click={toggleMenu}
					type="button"
					class="inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-backgroundAlt hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
